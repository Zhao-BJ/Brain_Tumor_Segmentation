...
def get_arguments():
    ...
    parser.add_argument('--epoch_num', default=1000)
    ...
    parser.add_argument('--save_path', default='/data2/aiteam_cta/ZhaoBJ/Projects/Brain_Tumor_Segmentation/demos/BraTS2018_Cropped_by_SegNet3D_Cross_Validation/results/SegNet3D')
    ...
    parser.add_argument('--visdom_env', default='BraTS2018_Cropped_by_SegNet3D_Cross_Validation/SegNet3D')
...
def main():
    ...
    # Data settings
    train_set = BraTS2018_ImgMask_Dataset(data_path=args.data_path, img_modality='all', mask_type='all')
    valid_set = BraTS2018_ImgMask_Dataset(data_path=args.data_path, img_modality='all', mask_type='all')
